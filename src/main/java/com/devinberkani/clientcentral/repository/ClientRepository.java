...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    Page<Client> findByBirthdayAndUser(LocalDate date, User user, Pageable pageable);
    Page<Client> findByBirthdayAfterAndUser(LocalDate date, User user, Pageable pageable);
}
